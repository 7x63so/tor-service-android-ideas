...
import xyz.gwh.test.tor.TorStatus;
import xyz.gwh.test.tor.controller.TorController;
import xyz.gwh.test.tor.controller.TorControllerImpl;
...
public class TorService extends Service implements EventHandler, Broadcaster.OnStatusChangedListener {
    ...
    public void onCreate() {
        ...
        try {
            installBinaries();
            torController = new TorControllerImpl(dirCache.getCanonicalPath(), resourceManager.getInstalledResources());
        } catch (Exception e) {
